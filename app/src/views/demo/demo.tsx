...
export default class Demo extends React.Component<DemoProps, DemoState> {
  ...
  render(): JSX.Element {
    const { resData, loading, createWindowLoading, asyncDispatchLoading } =
      this.state;
      ...
      <div className="layout-padding">
        <Card title="Redux Test" className="mb-16">
          ...
          <p className="text-gray mt-16 mb-16">
            Redux runs in the main process, which means it can be shared across
            all renderer processes.
          </p>
